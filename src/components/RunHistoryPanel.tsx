...
import type { RunRecord, RunNodeResult } from '../types';
...
const statusCls: Record<RunRecord['status'], string> = {
  success: 'text-ok',
  error: 'text-err',
  aborted: 'text-ink-faint',
};

const nodeStatusCls: Record<RunNodeResult['status'], string> = {
  idle: 'bg-[#d0d0d0]',
...
export default function RunHistoryPanel({ onClose }: { onClose: () => void }) {
