//! Endpoint and vault storage authority.
//!
//! This module owns AppData endpoint/vault persistence and AES-GCM API-key
//! encryption. Generic OS-keyring credentials remain in `credentials`.
